...
def main()->int:
    ...
    for geoid,name in GEOIDS.items():
        feature,url=fetch(geoid);requests[geoid]=url
        props=dict(feature.get("properties") or {});props["component_county_name"]=name;props["component_county_geoid"]=geoid
        raw.append({"type":"Feature","properties":props,"geometry":rounded(feature["geometry"])})
    ...
    properties={
      "geometry_id":"burnet-33rd-424th-district-attorney-service-area",
      "record_id":"TX:judicial_district:33-424:district_attorney_service_area:33-424",
      "jurisdiction_name":"33rd & 424th Judicial Districts",
      "district_type":"district_attorney_service_area",
      "district_id":"33-424",
      "district_name":"District Attorney Service Area — 33rd & 424th Judicial Districts",
      "source_agency":"U.S. Census Bureau",
      "source_layer":LAYER,
      "source_request_urls":requests,
      "source_retrieved_at":a.retrieved_at,
      "component_counties":component_names,
      "component_county_geoids":component_geoids,
      "component_count":4,
    }
    canonical={"type":"FeatureCollection","features":[{"type":"Feature","properties":properties,"geometry":rounded(mapping(union))}]}
    contract={
      "derivation_type":"exact_union_of_current_census_counties",
      "component_counties":component_names,
      "component_county_geoids":component_geoids,
      "component_count":4,
      "includes_burnet_county":True,
      "district_attorney_service_area_is_burnet_only":False,
      "source_layer":LAYER,
      "source_request_urls":requests,
      "source_retrieved_at":a.retrieved_at,
    }
    dump(a.raw_output,{"type":"FeatureCollection","features":raw});dump(a.output,canonical);dump(a.contract_output,contract)
    print("Built the four-county 33rd/424th District Attorney service area.")
    return 0
