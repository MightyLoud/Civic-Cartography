...
ISSUE_RULES = [
    ...
    (
        ...
        [r"\bbusiness licen[cs]e\b", r"\bapply for (?:a )?business licen[cs]e\b", r"\brenew (?:my )?business licen[cs]e\b", r"\bdo i need a business licen[cs]e\b", r"\bcity business licen[cs]e\b"],
        [],
        True,
        "institution",
        "",
    ...
    (
        ...
        [r"\bbuilding permit\b", r"\bconstruction permit\b", r"\bdeck permit\b", r"\bpermit for (?:a )?deck\b", r"\bwater heater permit\b", r"\bpermit for (?:a )?water heater\b", r"\belectrical permit\b", r"\bplumbing permit\b", r"\bmechanical permit\b", r"\broofing permit\b", r"\bhome improvement permit\b"],
        [],
        True,
        "institution",
        "",
    ...
    (
        ...
        [r"\bspecial event permit\b", r"\bevent permit\b", r"\bfestival permit\b", r"\bparade permit\b", r"\bpark event permit\b", r"\bblock party permit\b", r"\bfilm permit\b", r"\bpermit for (?:an )?event\b"],
        [],
        True,
        "institution",
        "",
    ...
    (
        ...
        [r"\buse variance\b", r"\bnon[- ]use variance\b", r"\bzoning variance\b", r"\bvariance from zoning\b", r"\bvariance request\b"],
        [],
        True,
        "institution",
        "",
    ...
    (
        ...
        [r"\brezone property\b", r"\brezone my property\b", r"\brezoning\b", r"\bzone change\b", r"\bchange zoning\b", r"\bzoning change\b"],
        [],
        True,
        "institution",
        "",
    ...
    (
        ...
        [r"\bdevelopment application\b", r"\bdevelopment plan\b", r"\bland development application\b", r"\bsubmit development plan\b", r"\bplanning application\b", r"\bpre[- ]application meeting\b", r"\bpreapp meeting\b", r"\bsite development review\b"],
        [],
        True,
        "institution",
        "",
    ...
    (
        ...
        [r"\bwhat is my zoning\b", r"\bzoning for this property\b", r"\bwhat can i build\b", r"\ballowed use\b", r"\bpermitted use\b", r"\bzoning district\b", r"\bproperty zoning\b", r"\bcan i use this property\b"],
        [],
        True,
        "institution",
        "",
    ...
    (
        ...
        [r"\bnoise complaint\b", r"\bloud party\b", r"\bexcessive noise\b", r"\bloud music\b", r"\bneighbor too loud\b", r"\bnoisy party\b"],
        [],
        True,
        "institution",
        "",
    ...
    (
        ...
        [r"\bparking violation\b", r"\billegal parking\b", r"\billegally parked\b", r"\bparked illegally\b", r"\bblocking my driveway\b", r"\bblocked driveway\b", r"\bno parking zone\b", r"\bparking enforcement\b"],
        [],
        True,
        "institution",
        "",
    ...
    (
        ...
        [r"\bfile (?:a )?police report\b", r"\bnon[- ]emergency police report\b", r"\bcrime no longer in progress\b", r"\breport stolen bike\b", r"\breport stolen car\b", r"\breport theft\b", r"\btheft report\b", r"\breport vandalism\b", r"\bvandalism report\b"],
        [],
        True,
        "institution",
        "",
    ...
    (
        ...
        [r"\bfire code violation\b", r"\bfire code complaint\b", r"\bblocked exit\b", r"\bexit blocked\b", r"\bsmoke detector not working\b", r"\bbroken smoke detector\b", r"\bblocked fire lane\b", r"\bfire lane blocked\b", r"\bfire hazard concern\b"],
        [],
        True,
        "institution",
        "",
