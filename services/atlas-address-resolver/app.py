...
ISSUE_RULES = [
    ...
    (
        ...
        [r"\billegal dumping\b", r"\billegally dumping\b", r"\billegally dumped\b", r"\bdumped yard waste\b", r"\byard waste dumped\b", r"\bnon[- ]hazardous waste\b", r"\bconcrete wash water\b", r"\bsmall spill\b", r"\billicit discharge\b"],
        [],
        True,
        "institution",
        "",
