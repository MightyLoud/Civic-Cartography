...
ISSUE_RULES = [
    ...
    (
        ...
        [r"\bovergrown weeds\b", r"\bovergrown vegetation\b", r"\btall weeds\b", r"\blitter on property\b", r"\bdebris on property\b", r"\bjunk outside\b", r"\boutside storage\b", r"\bjunk vehicle on property\b", r"\binoperable vehicle on private property\b", r"\brv storage violation\b", r"\bsidewalk blocked by vegetation\b"],
        [],
        True,
        "institution",
        "",
